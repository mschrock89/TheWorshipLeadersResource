-- Align setlist confirmation roster checks with the frontend weekend-roster logic.
-- Without this, users assigned to alias ministries such as sunday_am/weekend_team
-- can see a weekend setlist but still fail the confirm-eligibility RPC.
