-- Apply weekend-anchor filtering to setlist roster RPCs so production/video
-- volunteers only count when their team's weekend worship schedule matches.
-- Depends on support_schedule_has_weekend_anchor from 20260614120000.
