...
const videoPositionMapping: Record<string, { position: string; slot: string }> = {
  'tripod camera': { position: 'tri_pod_camera', slot: 'tri_pod_camera' },
  'tri-pod camera': { position: 'tri_pod_camera', slot: 'tri_pod_camera' },
  'tripod': { position: 'tri_pod_camera', slot: 'tri_pod_camera' },
  'camera': { position: 'tri_pod_camera', slot: 'tri_pod_camera' },
  'camera 1': { position: 'tri_pod_camera', slot: 'tri_pod_camera' },
  'camera 2': { position: 'tri_pod_camera', slot: 'tri_pod_camera' },
  'camera 3': { position: 'tri_pod_camera', slot: 'tri_pod_camera' },
  'camera 4': { position: 'tri_pod_camera', slot: 'tri_pod_camera' },
  'camera 5': { position: 'tri_pod_camera', slot: 'tri_pod_camera' },
  'camera 6': { position: 'tri_pod_camera', slot: 'tri_pod_camera' },
  'handheld camera': { position: 'hand_held_camera', slot: 'hand_held_camera' },
  'hand-held camera': { position: 'hand_held_camera', slot: 'hand_held_camera' },
  'hand held camera': { position: 'hand_held_camera', slot: 'hand_held_camera' },
  'handheld': { position: 'hand_held_camera', slot: 'hand_held_camera' },
  'hand-held': { position: 'hand_held_camera', slot: 'hand_held_camera' },
  'hand held': { position: 'hand_held_camera', slot: 'hand_held_camera' },
