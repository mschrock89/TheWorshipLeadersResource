...
export function useUserRole(userId: string | undefined) {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const priorityOrder: AppRole[] = ['admin', 'campus_admin', 'campus_worship_pastor', 'student_worship_pastor', 'campus_pastor', 'speaker', 'leader', 'audition_candidate', 'volunteer', 'member'];
...
export function useUpdateBaseRole() {
  ...
  return useMutation({
    mutationFn: async ({ userId, role }: { userId: string; role: AppRole }) => {
      const baseRoles: AppRole[] = ['network_worship_pastor', 'campus_worship_pastor', 'student_worship_pastor', 'campus_pastor', 'speaker', 'video_director', 'production_manager', 'audition_candidate', 'volunteer', 'leader', 'member'];
