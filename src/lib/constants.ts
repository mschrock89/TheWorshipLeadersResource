...
export const POSITION_SLOTS: {
  ...
  // Video slots
  { slot: "tri_pod_camera", label: "Tri-Pod Camera", category: "Video", position: "tri_pod_camera" },
  { slot: "hand_held_camera", label: "Hand-Held Camera", category: "Video", position: "hand_held_camera" },
