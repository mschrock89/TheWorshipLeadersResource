  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="sticky top-0 z-30 border-b border-border bg-background/85 backdrop-blur-md">
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-4 sm:px-6" style={headerStyle}>
      ...
      <main className="relative mx-auto flex w-full max-w-7xl flex-col py-6 sm:py-8" style={mainStyle}>
        {children}
      </main>
    </div>
  );
